  ...
  <div class="rowoutside">
    <div class="col-lg-12">
      <div class="main-profile ">
        <div class="row">
          <div class="col-lg-4">
            <img src="src/assets/images/profile.jpg" alt="" style="border-radius: 23px;">
          </div>
          <div class="col-lg-4 align-self-center">
            <div class="main-info header-text">
              ...
              <div class="main-border-button">
                <router-link to="/register">Start Game</router-link>
              </div>
            </div>
          </div>
          <div class="col-lg-4 align-self-center">
            ...
            <br />
            <ul>
              <li>Games <span>no</span></li>
              <li>Friends Online <span>no</span></li>
              <li>achievement <span>no</span></li>
            </ul>
          </div>
        </div>
      </div>
