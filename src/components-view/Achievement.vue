...
<div class="gaming-library">
    <div class="col-lg-12">
        ...
        <div class="item">
        <ul>
            <li><img src="src/assets/images/computing.png" alt="" class="templatemo-item"></li>
            <li><h4>第一个2048</h4></li>
            <li><h4></h4><span></span></li>
            <li><h4>Time</h4><span>no </span></li>
            <li><h4>Percentage Complete</h4><span>50%</span></li>
            <li><div class="main-border-button border-no-active"><a href="#">Not Finish</a></div></li>
        </ul>
        </div>
        <div class="item">
        <ul>
            <li><img src="src/assets/images/ages.png" alt="" class="templatemo-item"></li>
            <li><h4>进行一场对战</h4><span></span></li>
            <li><h4></h4><span></span></li>
            <li><h4>Time</h4><span>2023/9/13 12:30</span></li>
            <li><h4>Percentage Complete</h4><span>80%</span></li>
            <li><div class="main-border-button"><a href="#">Finish</a></div></li>
        </ul>
        </div>
        <div class="item last-item">
        <ul>
            <li><img src="src/assets/images/paper.png" alt="" class="templatemo-item"></li>
            <li><h4>获得一次胜利</h4><span></span></li>
            <li><h4></h4><span></span></li>
            <li><h4>Time</h4><span>no</span></li>
            <li><h4>Percentage Complete</h4><span>30%</span></li>
            <li><div class="main-border-button border-no-active"><a href="#">Not Finish</a></div></li>
        </ul>
        </div>
    </div>
