  ...
  <div class="col-lg-4">
    <div class="top-streamers">
      ...
      <ul>
        <li>
          <span>01</span>
            <img src="src/assets/images/avatar-01.jpg" alt="" style="max-width: 46px; border-radius: 50%; margin-right: 15px;">
        ...
        <li>
          <span>02</span>
          <img src="src/assets/images/avatar-02.jpg" alt="" style="max-width: 46px; border-radius: 50%; margin-right: 15px;">
        ...
        <li>
          <span>03</span>
          <img src="src/assets/images/avatar-03.jpg" alt="" style="max-width: 46px; border-radius: 50%; margin-right: 15px;">
        ...
        <li>
          <span>04</span>
          <img src="src/assets/images/avatar-04.jpg" alt="" style="max-width: 46px; border-radius: 50%; margin-right: 15px;">
