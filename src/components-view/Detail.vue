        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="feature-banner header-text">
              <div class="row">
                <div class="col-lg-4">
                  <img src="src/assets/images/R-C.jpg" alt="" style="border-radius: 23px;">
                </div>
                <div class="col-lg-8">
                  <div class="thumb">
                    <img src="src/assets/images/feature-right.jpg" alt="" style="border-radius: 23px;">
                    <a href="https://2048.wheatjs.me/" target="_blank"><i class="fa fa-play"></i></a>
                  </div>
                </div>
              </div>
            </div>
        ...
        <div class="game-details">
          ...
          <div class="col-lg-12">
            <div class="content">
              ...
              <div class="row">
                ...
                <div class="col-lg-6">
                  <div class="right-info">
                    <ul>
                      <li><i class="fa fa-server"></i> MORE</li>
                      <li><i class="fa fa-gamepad"></i> PLAY</li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="row">
                <div class="col-lg-4">
                  <img src="src/assets/images/details-01.jpg" alt="" style="border-radius: 23px; margin-bottom: 30px;">
                </div>
                <div class="col-lg-4">
                  <img src="src/assets/images/details-02.jpg" alt="" style="border-radius: 23px; margin-bottom: 30px;">
                </div>
                <div class="col-lg-4">
                  <img src="src/assets/images/details-03.jpg" alt="" style="border-radius: 23px; margin-bottom: 30px;">
                </div>
              </div>

              <div class="row">
                <div class="col-lg-12">
                  <p>1.向一个方向滑动，所有格子会向那个方向运动。 2.相同数字的两个格子，相撞时数字会相加。 3.每次滑动时，空白处会随机刷新一个数字的格子。 4.当界面不可运动时（当界面全部被数字填满时），游戏结束；当界面中最大数字是2048时，游戏胜利。</p>
                </div>
              </div>
