  ...
  <div class="row">
    <div class="col-lg-12">
      <div class="heading-section">
        <h4><em>Popular Games</em> Right Now</h4>
      </div>
      <div class="row">
        <div class="col-lg-3 col-sm-6">
          <div class="item">
            <img src="src/assets/images/yuanshen.jpg" alt="">
            <h4>Genshin Impact<br><span>RPG</span></h4>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="item">
            <img src="src/assets/images/yunding.png" alt="">
            <h4>Teamfight Tactics<br><span>Auto Chess</span></h4>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="item">
            <img src="src/assets/images/apex.png" alt="">
            <h4>Apex:Legend<br><span>Gun Game</span></h4>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="item">
            <img src="src/assets/images/sekiro.png" alt="">
            <h4>Sekiro:Shadown Die Twice<br><span>Soulslike Game</span></h4>
          </div>
        </div>
      </div>
      <div class="row">
        <div class="col-lg-3 col-sm-6">
          <div class="item">
            <img src="src/assets/images/minecraft.png" alt="">
            <h4>Minecraft<br><span>Sandbox Game</span></h4>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="item">
            <img src="src/assets/images/2077.jpg" alt="">
            <h4>Cyberpunk:2077<br><span>RPG</span></h4>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="item">
            <img src="src/assets/images/lushi.jpg" alt="">
            <h4>Heartstone<br><span>Card Game</span></h4>
          </div>
        </div>
        <div class="col-lg-3 col-sm-6">
          <div class="item">
            <img src="src/assets/images/lol.jpg" alt="">
            <h4>League of Legend<br><span>MOBA</span></h4>
          </div>
        </div>
      </div>
    </div>
